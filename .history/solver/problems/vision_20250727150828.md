...
your goal is to justify it as much as you can, from first principles and economics. if you find missing components, you can add components so the overall goal of the proposal is still being achieved. Jusify the components that you'll add. 