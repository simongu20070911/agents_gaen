...
And that the deflationary cause, with the fact that the AI system aims to maximize its token value relative to and sells productions in its token value
