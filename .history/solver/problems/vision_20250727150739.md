...
And that the deflationary cause, with the fact that the AI system aims to maximize its token value relative to its products and sells productions in its token value, will cause investors to buy its tokens as its the only garanteed appreciating substance, reinjecting capital into the system and enbetter 
