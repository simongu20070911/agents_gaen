...
def get_experiment_executor_agent() -> MicroCheckpointExperimentExecutor:
    """Factory function to create an Experiment Executor agent."""
    from ..tools.mcp_tools import get_desktop_commander_mcp_tools
    
    # Get LLM model and tools
    model = get_llm_model()
    tools = get_desktop_commander_mcp_tools()
    
    # Create instruction provider function
    def instruction_provider():
        return EXPERIMENT_EXECUTOR_INSTRUCTION
