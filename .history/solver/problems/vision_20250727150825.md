...
And that the deflationary cause, with the fact that the AI system aims to maximize its token value relative to its products and sells productions in its token value, will cause investors to buy its tokens as its the only garanteed appreciating substance, reinjecting capital into the system and enbetter the human. The AI will analyze on chain which individual have least money by analyzing on chain behavior(you need to justify how), to make sure that those who started poor gets balanced 
