...
Read and Write limit of underlying MCP desktop comamnder tool is <x>, <y> lines which you'd query on and find out. 
should be 7000, 2000. if lower than that, immediately raise a warning. 
